...
import ActiveAction from './Active.action.test.svelte';
import ActiveAttachment from './Active.attachment.test.svelte';
...
describe('active', () => {
  ...
  describe.each([
    { component: ActiveAttachment, title: 'attachment' },
    { component: ActiveAction, title: 'action' },
  ])('active $title', ({ component, title }) => {
    describe('init', () => {
      const mockStyle = {
        setProperty: vi.fn(),
