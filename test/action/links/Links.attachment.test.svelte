...
<RouterView {router}>
  <div data-testid="default" {@attach useLinks()}>
  ...
  <div data-testid="navigate" {@attach useLinks({ navigate: { replace: true } })}>
  ...
  <div data-testid="apply" {@attach useLinks({ apply: (node: HTMLElement) => node.dataset.path || node.dataset.name })}>
  ...
  <div data-testid="outside-boundary" data-router-link data-name="home">
    <div data-testid="boundary" {@attach useLinks({ boundary: (node: HTMLElement) => node.dataset.testid === 'boundary-nested' })}>
  ...
  <div data-testid="resolve" {@attach useLinks({ navigate: { resolve: true } })}>
